...
public class UpgradableHumble : InteractableHumble
{
    ...
    public int EnableCorrectUpgradeMesh(Upgrade[] upgrades)
    {
        ...
        {
            upgradeMeshIndex++;
            if ((upgrade.UpgradeSO.Socket_1 == socket_1_chip_type && upgrade.UpgradeSO.Socket_2 == socket_2_chip_type) || (upgrade.UpgradeSO.Socket_2 == socket_1_chip_type && upgrade.UpgradeSO.Socket_1 == socket_2_chip_type))
            {
                break;
            }
        }
